...
export default function Header(props) {
  const role = [{field: props.userInfo.role}];
  const profile =
    ...
    return (
      <div id="header" className="header">
        <NavLink to="/catalog" className="header-logo"><img src={logoSrc} alt="" className="header-logo" /></NavLink>
        ...
        <div className={mobileActive ? "mask-header-mobile-menu active" : "mask-header-mobile-menu"}>
          <ul className="header-mobile-menu">
            <NavLink to="/edit_profile" className="header-mobile-profile" onClick={() => setMobileActive(false)}>
            ...
            <li className="header-menu-li"><NavLink to="/catalog" className="header-menu-a" onClick={() => setMobileActive(false)}><img src="img/myCatalog.png" alt="" className="myCatalog" /><img src="img/myCatalog-active.png" alt="" className="myCatalog-active" />Каталог</NavLink></li>
            <li className="header-menu-li"><NavLink to="/my_courses" className="header-menu-a" onClick={() => setMobileActive(false)}><img src="img/myCourse.png" alt="" className="myCourse" /><img src="img/myCourse-active.png" alt="" className="myCourse-active" />Мои курсы</NavLink></li>
            <li className="header-menu-li"><NavLink to="/Chat" className="header-menu-a" onClick={() => setMobileActive(false)}><img src="img/myTask.png" alt="" className="myTask" /><img src="img/myTask-active.png" alt="" className="myTask-active" />Мои задания</NavLink></li>
            { role.map(() => {
                if (props.userInfo.role == "ADMIN")
                  return (
                    <NavLink to="/admin_page/stats" className="header-menu-li header-menu-a" activeClassName="header-menu-li-active">Switch admin</NavLink>
                  )
              })
            }
            <li className="header-menu-li header-mobile-menu-logout"><a href="#" className="header-menu-a" onClick={logout}><img src="img/logout.png" alt="" className="logout-img" />Выйти</a></li>
          </ul>
          <a href="#" className="close-header-mobile"><img src="img/closeMobileMenu.png" alt="" onClick={() => setMobileActive(false)}/></a>
        </div>
        <ul className="header-menu">
          <NavLink to="/catalog" className="header-menu-li header-menu-a" activeClassName="header-menu-li-active">Каталог</NavLink>
          <NavLink to="/my_courses" className="header-menu-li header-menu-a" activeClassName="header-menu-li-active">Мои курсы</NavLink>
          <NavLink to="/chat" className="header-menu-li header-menu-a" activeClassName="header-menu-li-active">Мои задания</NavLink>
          { role.map(() => {
              if (props.userInfo.role == "ADMIN")
                return (
                  <NavLink to="/admin_page/stats" className="header-menu-li header-menu-a" activeClassName="header-menu-li-active">Switch admin</NavLink>
        ...
        <NavLink to="/edit_profile" className="header-profile" activeClassName="header-menu-li-active">
          <img src="img/profile2x.png" alt="" className="header-profile-img" />
          <div className="header-profile-info">
            <p className="text-reg-1 header-profile-name">{profile.name_profile}</p>
            <p className="text-reg-2 header-profile-city">{props.userInfo.email}</p>
