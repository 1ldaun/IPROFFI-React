...
export default function LandingPage(props) {
  ...
  var number = url.match(/landing\/(.+)/)[0];
  number = number.toString().slice(8);
  ...
  useEffect(() => {
    ...
    if (couponValue !== "") {
      elem.classList.add('coupon-active');
    }
    else {
      elem.classList.remove('coupon-active');
    }
  }, [couponValue]);

  useEffect(() => {
    const apiUrl = 'https://i-proffi.com/api/v1/courses/' + number;
    ...
    return (
      <form id="form" className="register-htmlFor-course" onSubmit={handleSubmit}>
        <div className="register-htmlFor-course-left">
          <p className="h2-sb register-h2">Записаться на курс или
            получить бесплатную
            консультацию</p>
        </div>
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className="landing-header">
        ...
        <NavLink to="/login" className="landing-sign_in">Войти</NavLink>
      </div>

      <div className="question-block">
        <div className="question-none">
          <img src="img/tg2x.png" alt="telegram" className="tg-img"/>
          <img src="img/wa2x.png" alt="wats'up" className="wa-img"/>
        </div>
          ...
          <div className="business-analyst-right">
            <div className="business-analyst-right-top">
              ...
              <p className="text-reg-2 business-text">{data.landing_info.subtitle}</p>
                ...
                <Link className="a-button-sign-in" to="form" smooth={true}><input type="button"
        ...
        <div className="specialist-market">
          <div className="specialist-market-item specialist-h">
            <p className="h2-sb">На рынке требуются<br/>
              специалисты</p>
          </div>
        ...
        <div className="register-htmlFor-course">
          <div className="register-htmlFor-course-left">
            <p className="h2-sb">Записаться на курс или
              получить бесплатную
              консультацию</p>
          </div>
          <div className="register-htmlFor-course-right">
            <div className="name">
              <label htmlFor="" className="text-reg-2 label-sign-in h-19">Имя</label>
              <input type="text" id="name" className="input-sign-in"/>
            </div>
            <div className="phone">
              <label htmlFor="" className="text-reg-2 label-sign-in h-19">Телефон</label>
              <input type="text" id="phone" className="input-sign-in"/>
            </div>
            <div className="email-register">
              <label htmlFor="" className="text-reg-2 label-sign-in h-19">Email</label>
              <input type="text" id="email" className="input-sign-in"/>
            </div>
              <div className="div-button-sign-in h1-sign-in">
                <a className="a-button-sign-in" href="#"><input type="button"
                  className="button-sign-in button-disabled-sign-in button-default-sign-in"
                  value="Записаться на курс"/></a>
            </div>
            <div className="text-reg-3 personal-text">
