...
export default function ModuleAdminCourses(props) {
...
useEffect(() => {
  if (edit_course_flag) {
    ...
    "landing_info": {
      "main_img_src": "string",
      "title": (title) ? title : "",
      "name_of_teacher": name_of_teacher ? name_of_teacher : "",
      "subtitle": subtitle ? subtitle : "",
      "duration": durationLand ? durationLand : "",
      "online": online ? online : "",
      "education": education ? education : "",
      "efficiency": efficiency ? efficiency : "",
      "count_company": count_company ? count_company : "",
      "subtitle_company": subtitle_company ? subtitle_company : "",
      "count_rubles": count_rubles ? count_rubles : "",
      "subtitle_rubles": subtitle_rubles ? subtitle_rubles : "",
      "course_for": [
        {
          "img_src": "string",
          "title": course_for0title ? course_for0title : "",
          "subtitle": course_for0subtitle ? course_for0subtitle : ""
        },
        {
          "img_src": "string",
          "title": course_for1title ? subtitle : "",
          "subtitle": course_for1subtitle ? subtitle : ""
        },
        {
          "img_src": "string",
          "title": course_for2title ? course_for2title : "",
          "subtitle": course_for2subtitle ? course_for2subtitle : ""
        }
      ],
      "what_you_learn": what_you_learn ? what_you_learn : "",
      "program": {
        "title": programTitle ? programTitle : "",
        "subtitles_list": program ? program : ""
      },
      "cv_position": cv_position ? cv_position : "",
      "cv_payment": cv_payment ? cv_payment : "",
      "skills_list": skills ? skills : ""
    },
    "course_products": [
      {
        "course_product_id": productId,
        "discount": parseInt(discount) ? parseInt(discount) : 10,
        "discount_type": "P",
        "title": "string",
        "description": "string",
        "duration": duration,
...
useEffect(() => {
  ...
  axios.get(apiUrl).then((repos) => {
    ...
    setProductId(allRepos.course_products[0].course_product_id);
  ...
  function AddLandForm() {
    ...
    return (
      ...
      <form className="new-course-form" onSubmit={handleSubmit}>
        ...
        <input type="text" className="new-course-input inp-sz-2" value={name} placeholder="Бизнес-аналитик с нуля" onChange={(e) => setName(e.target.value)}/>

        <label htmlFor="" className="new-course-label">Описание курса</label>
        <textarea className="new-course-input inp-sz-2 new-course-input-desc" value={description} placeholder="С Еленой Мишлен" onChange={(e) => setDescription(e.target.value)}></textarea>

        <label htmlFor="" className="new-course-label">Цена</label>
        <input type="text" className="new-course-input inp-sz-2" value={price} placeholder="15000" onChange={(e) => setPrice(e.target.value)}/>
        ...
        <div className="new-course-block">
          ...
          <input type="text" className="new-course-input inp-sz-1" value={duration} placeholder="До 15 марта" onChange={(e) => setDuration(e.target.value)}/>
        </div>

        <div className="new-course-block">
          <label htmlFor="" className="new-course-label">Интервал уроков</label>
          <select type="text" className="new-course-input inp-sz-1" disabled>
        ...
        <select type="text" className="new-course-input inp-sz-2" disabled>
    ...
    return (
      <span className="root-span">
        <GoodAlert setActive={setAlert} active={alert}>
          Лендинг успешно добавлен!
        </GoodAlert>
      <div className="admin-courses">
        <p className="text-reg-1 h-course h-teacher">Курсы ({(courses[0].title == "loading...") ? "loading..." : courses.length})</p>
        <button className="add_course-button text-reg-2" onClick={() => {setModalActive(true); setSaved_course_id(0);}}><img src={addAdmin} alt="" /></button>
                ...
                <div className="body-landing-unregister">
                  ...
                  <div className="business-analyst">
                    ...
                    <div className="business-analyst-right">
                      <div className="business-analyst-right-top">
                        ...
                        <input className="edit-landing-input" value={title} placeholder="Бизнес-аналитик с нуля" onChange={(e) => setTitle(e.target.value)}/>
                        <label className="edit-landing-label">Имя Фамилия преподавателя</label>
                        <input className="edit-landing-input" value={name_of_teacher} placeholder="С Еленой Мишлен" onChange={(e) => setName_of_teacher(e.target.value)}/>
                        <label className="edit-landing-label">Текст - мотивация курса</label>
                        <input className="edit-landing-input" value={subtitle} placeholder="Всего за месяц вы освоите профессию бизнес аналитика и сможете поднять свой уровень дохода от 90 т.р." onChange={(e) => setSubtitle(e.target.value)}/>
                      </div>
                  ...
                  <div className="business-footer h-57">
                    <div className="business-footer-item duration">
                      ...
                      <div className="h-55">
                        ...
                        <input className="edit-landing-input" value={durationLand} placeholder="1 месяц" onChange={(e) => setDurationLand(e.target.value)}/>
                      </div>
                    </div>
                    <div className="business-footer-item online">
                      ...
                      <div className="h-55">
                        ...
                        <input className="edit-landing-input" value={online} placeholder="в удобное время" onChange={(e) => setOnline(e.target.value)}/>
                      </div>
                    </div>
                    <div className="business-footer-item studying">
                      ...
                      <div className="h-55">
                        ...
                        <input className="edit-landing-input" value={education} placeholder="На практике " onChange={(e) => setEducation(e.target.value)}/>
                      </div>
                    </div>
                    <div className="business-footer-item effective">
                      ...
                      <div className="h-55">
                        ...
                        <input className="edit-landing-input" value={efficiency} placeholder="Персонализировано" onChange={(e) => setEfficiency(e.target.value)}/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="specialist-market">
                    ...
                    <div className="specialist-market-item specialist-block">
                      <input className="edit-landing-input " value={count_company} placeholder="500" onChange={(e) => setCount_company(e.target.value)}/>
                      <h2 className="h2-sb h2-edit-company">компаний</h2>
                      <p className="text-reg-2"><input className="edit-landing-input" value={subtitle_company} placeholder="Сейчас ищут бизнес аналитика" onChange={(e) => setSubtitle_company(e.target.value)}/></p>
                    </div>
                    <div className="specialist-market-item specialist-block">
                      <input className="edit-landing-input " value={count_rubles} placeholder="150 000" onChange={(e) => setCount_rubles(e.target.value)}/>
                      <h2 className="h2-sb h2-edit-company">рублей</h2>
                      <p className="text-reg-2"><input className="edit-landing-input" value={subtitle_rubles} placeholder="Зарплата специалиста" onChange={(e) => setSubtitle_rubles(e.target.value)}/></p>
                    </div>
                  </div>
                  ...
                  <div className="audience">
                    ...
                    <div className="audience-course">
                      <div className="audience-course-item">
                        ...
                        <input className="edit-landing-input" value={course_for0title} placeholder="Новичкам" onChange={(e) => setCourseFor0Title(e.target.value)}/>
                      ...
                      <div className="audience-course-item">
                        ...
                        <input className="edit-landing-input" value={course_for1title} placeholder="Кто в поиске" onChange={(e) => setCourseFor1Title(e.target.value)}/>
                        <input className="edit-landing-input" value={course_for1subtitle} onChange={(e) => setCourseFor1Subtitle(e.target.value)}/>
                      </div>
                      <div className="audience-course-item">
                        <img src="img/robot@2x.png" alt="robot" className="img-robot img-audience"/>
                        <input className="edit-landing-input" value={course_for2title} placeholder="Повышение квалификации" onChange={(e) => setCourseFor2Title(e.target.value)}/>
                  ...
                  <div className="program">
                    ...
                    <div className="program-list">
                      <div className="program-list-item program-list-item-edit">
                        ...
                        <textarea className="edit-landing-textarea" value={program[0].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setProgram([{text: e.target.value}, program[1], program[2], program[3], program[4], program[5]])}}/>
                      </div>
                      <div className="program-list-item program-list-item-edit">
                        <p className="numerate-list text-reg-1">2</p>
                        <textarea className="edit-landing-textarea" value={program[1].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setProgram([program[0], {text: e.target.value}, program[2], program[3], program[4], program[5]])}}/>
                      </div>
                      <div className="program-list-item program-list-item-edit">
                        <p className="numerate-list text-reg-1">3</p>
                        <textarea className="edit-landing-textarea" value={program[2].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setProgram([program[0], program[1], {text: e.target.value}, program[3], program[4], program[5]])}}/>
                      </div>
                      <div className="program-list-item program-list-item-edit">
                        <p className="numerate-list text-reg-1">4</p>
                        <textarea className="edit-landing-textarea" value={program[3].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setProgram([program[0], program[1], program[2], {text: e.target.value}, program[4], program[5]])}}/>
                      </div>
                      <div className="program-list-item program-list-item-edit">
                        <p className="numerate-list text-reg-1">5</p>
                        <textarea className="edit-landing-textarea" value={program[4].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setProgram([program[0], program[1], program[2], program[3], {text: e.target.value}, program[5]])}}/>
                      </div>
                      <div className="program-list-item program-list-item-edit">
                        <p className="numerate-list text-reg-1">6</p>
                        <textarea className="edit-landing-textarea" value={program[5].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setProgram([program[0], program[1], program[2], program[3], program[4], {text: e.target.value}])}}/>
                      </div>
                    ...
                    <div className="resume-business-analyst">
                      <div className="resume-business-analyst-left">
                        ...
                        <div>
                          ...
                          <input className="edit-landing-input" value={cv_position} placeholder="Бизнес-аналитик" onChange={(e) => setСv_position(e.target.value)}/>
                        </div>
                      </div>
                      <div className="resume-business-analyst-right">
                        <p className="resume-p">Зарплата от:</p>
                        <input className="edit-landing-input" value={cv_payment} placeholder="90 000 руб." onChange={(e) => setСv_payment(e.target.value)}/>
                      </div>
                    </div>
                    <div className="resume-skills">
                      ...
                      <div className="resume-skills-list">
                        <div className="resume-skills-list-item">
                          ...
                          <textarea className="edit-landing-textarea" value={skills[0].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([{text: e.target.value}, skills[1], skills[2], skills[3], skills[4], skills[5], skills[6], skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[1].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], {text: e.target.value}, skills[2], skills[3], skills[4], skills[5], skills[6], skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[2].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], skills[1], {text: e.target.value}, skills[3], skills[4], skills[5], skills[6], skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[3].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], skills[1], skills[2], {text: e.target.value}, skills[4], skills[5], skills[6], skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[4].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], skills[1], skills[2], skills[3], {text: e.target.value}, skills[5], skills[6], skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[5].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], skills[1], skills[2], skills[3], skills[4], {text: e.target.value}, skills[6], skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[6].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], skills[1], skills[2], skills[3], skills[4], skills[5], {text: e.target.value}, skills[7]])}}/>
                        </div>
                        <div className="resume-skills-list-item">
                          <div className="sircle-2"></div>
                          <textarea className="edit-landing-textarea" value={skills[7].text} placeholder="Необязательно для заполнения" onChange={(e) =>  {setSkills([skills[0], skills[1], skills[2], skills[3], skills[4], skills[5], skills[6], {text: e.target.value}])}}/>
                        </div>
                      </div>
                    </div>
                  </div>
