...
export default function ModuleTeacherPupils() {
  ...
  <option key={option.id} value={option.name}>{option.name}</option>
    ...
    return (
      <div className="admin-pupils">
        ...
        <Route path='/teacher_page/pupils/archive'>
